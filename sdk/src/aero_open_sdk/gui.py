...
"""
firmware_gui.py - Minimal GUI for Dexterous Hand (16-byte serial protocol)

A simple Tkinter GUI to control the Dexterous Hand via serial port:
...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Dexterous Hand Control")
